...
function TagCard({ number, title, text, className, aosDelay, aosType, pathLength, containerRef }) {
...
const steps = [
  {
    number: '01',
    title: 'Analyze',
    text: 'We start by understanding your requirements, defining test strategies, and identifying critical quality gates to ensure comprehensive coverage.',
  },
  {
    number: '02',
    title: 'Design',
    text: 'Creating scalable automation architectures using hybrid frameworks, Page Object Model, and data-driven approaches for maximum reusability.',
  },
  {
    number: '03',
    title: 'Automate',
    text: 'Developing robust test suites with Selenium, Tosca, and Java — automating 500+ test cases and integrating with CI/CD pipelines.',
  },
  {
    number: '04',
    title: 'Deliver',
    text: 'Rigorous execution, defect tracking, and actionable reporting — ensuring 95%+ test coverage and zero-defect production deployments.',
  },
]
...
function Process() {
  ...
  return (
    <section id="process" ref={containerRef} className="bg-white pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:80px_80px]">
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-[1.1] mb-6 tracking-tight relative">
            Let me show you how I drive quality to new heights
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            A structured, methodical approach to turn complex requirements into bulletproof test automation.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          {steps.map((step, i) => (
            <TagCard
              ...
              text={step.text}
              className={
                i === 0 ? 'md:absolute md:top-[10px] md:right-[5%] lg:right-[10%] rotate-2 md:rotate-6' :
                i === 1 ? 'md:absolute md:top-[450px] md:left-[5%] lg:left-[10%] -rotate-2 md:-rotate-6' :
                i === 2 ? 'md:absolute md:top-[700px] md:right-[5%] lg:right-[15%] rotate-1 md:rotate-3' :
          ...
          <div data-aos="fade-in" data-aos-delay="600" className="hidden md:block absolute top-[1250px] left-[60%] font-['Caveat',cursive] text-3xl text-gray-600 rotate-6">
